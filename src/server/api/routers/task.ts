...
import { createTRPCRouter, publicProcedure } from "../trpc";
  ...
  export const taskRouter = createTRPCRouter({
    ...
    It's a query procedure, meaning it's designed for fetching/reading data.
    ...
    - async ({ ctx }): The resolver function receives a ctx (context) object.
      The context is configured in your main tRPC file and typically contains things
    ...
    The data returned by this function is automatically serialized and sent to the client.
    tRPC also infers the TypeScript type of this return value, giving you full
 ...
 *
 * - `.input(z.object({ title: z.string().min(1) }))`: This is a crucial step.
 ...
 *   - `ctx.db.task.create()`: Calls the `create` method on our Prisma `Task` model.
 ...
 *     automatically by Prisma/the database based on the `@default` rules in your schema.
 *
 ...
 */
    ...
    // Defines a new mutation procedure named 'toggle.
    ...
    // Defines a new mutation procedure named 'delete'.
