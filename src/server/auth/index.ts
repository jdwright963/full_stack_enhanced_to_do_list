// This file, `src/server/auth/index.ts`, is automatically generated by `create-t3-app`.
// It is the main entry point and initialization file for the NextAuth.js (Auth.js) library.
...
//   sign users in or out from server-side code (e.g., in a Server Action).
//
